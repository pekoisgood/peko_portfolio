...
const data = [
  {
    ...
    description: "A blog that shares film I took. This website was developed with Html, Css, JavaScript and Bootstrap.",
  ...
  },
  {
    ...
    description: "It'a JavaScript project to generate 2 random password that you can decide numbers and type of character.",
  ...
  },
  {
    ...
    description: "A JavaScript project tp fetch content from the API. Submit the question and it'll display a random answer of yes or no with a GIF.",
  ...
  },
  {
    ...
    description: "A React quiz project fetched questions and answers from Opendb.Practing useState, useEffect in React. Also using Figma with design provided by Scrimba.",
  ...
  },
  {
    ...
    description: "Personal website built with React, JavaScript, and css. In React, this project practices concept of component , useRef method, Emailjs and React-icons.",
  ...
  return (
    <section id='portfolio'>
        ...
        <div className='portfolio-container'>
          {
            data.map(({id, image, title, github, demo, description, hashTags}) => {
              ...
              return (
                <article key={id} className="portfolio_item">
                  ...
                  <div className='portfolio-hashTags'>{hashTags.map((hashTag) => {
                    return (<span className='portfolio-hashTag'>#{hashTag}</span>)
                  })}</div>
                </article>
              )
            })
